        ...
        <div className={styles.container}>
            ...
            <div className={styles.recentChats}>
                <div className={styles.recentHeader}>
                    ...
                    <button className={styles.newChatButton} onClick={() => router.push('/salesmate')}>
                ...
                <div className={styles.chatGrid}>
                    {chats.map((item) => (
                        <div key={item.chat_id} className={styles.chatCard} onClick={() => router.push('/salesmate?id=' + item.chat_id)}>
